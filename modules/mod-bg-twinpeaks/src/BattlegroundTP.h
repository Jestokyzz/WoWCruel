...
enum TwinPeaksStrings {
    LANG_BG_TP_START_TWO_MINUTES        = 18193,
    LANG_BG_TP_START_ONE_MINUTE         = 41186,
    LANG_BG_TP_START_HALF_MINUTE        = 41187,
    LANG_BG_TP_HAS_BEGUN                = 18196,
    LANG_BG_TP_CAPTURED_HF              = 9801,
    LANG_BG_TP_CAPTURED_AF              = 9802,
    LANG_BG_TP_DROPPED_HF               = 9806,
    LANG_BG_TP_DROPPED_AF               = 9805,
    LANG_BG_TP_RETURNED_AF              = 9808,
    LANG_BG_TP_RETURNED_HF              = 9809,
    LANG_BG_TP_PICKEDUP_HF              = 9807,
    LANG_BG_TP_PICKEDUP_AF              = 9804,
    LANG_BG_TP_F_PLACED                 = 9803,
    LANG_BG_TP_ALLIANCE_FLAG_RESPAWNED  = 9803,
    LANG_BG_TP_HORDE_FLAG_RESPAWNED     = 9803
};
...
protected:
    ...
    BattlegroundTPScore(ObjectGuid playerGuid) : BattlegroundScore(playerGuid) { }
...
class AC_GAME_API BattlegroundTP : public Battleground
{
    ...
    private:
        ...
        uint32 _trackerUpdateTimer = 0;

        void PostUpdateImpl(uint32 diff) override;
        void SendTrackerState(Player const* player) const;
        void BroadcastTrackerState() const;
};
#endif
