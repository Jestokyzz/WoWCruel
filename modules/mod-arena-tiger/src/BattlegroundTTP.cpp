...
BattlegroundTypeId BATTLEGROUND_TTP = BattlegroundTypeId(103); // internal uint8 ID; .pvpport alias is 871
...
bool BattlegroundTTP::SetupBattleground()
{
    ...
    // Buffs
        || !AddObject(BG_TTP_OBJECT_BUFF_1, BG_TTP_OBJECT_TYPE_BUFF_1, 566.788f, 602.743f, 383.68f, 1.5724f, 0.0f, 0.0f, 0.707673f, 0.70654f, ARENA_SHADOW_SIGHT_RESPAWN)
        || !AddObject(BG_TTP_OBJECT_BUFF_2, BG_TTP_OBJECT_TYPE_BUFF_2, 566.661f, 664.311f, 383.681f, 4.66374f, 0.0f, 0.0f, 0.724097f, -0.689698f, ARENA_SHADOW_SIGHT_RESPAWN))
    {
