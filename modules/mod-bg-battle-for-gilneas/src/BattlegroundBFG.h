...
enum BattleForGilneasStrings {
    // Battle For Gilneas
    LANG_BG_BFG_START_TWO_MINUTES           = 18193,
    LANG_BG_BFG_START_ONE_MINUTE            = 18194,
    LANG_BG_BFG_START_HALF_MINUTE           = 18195,
    LANG_BG_BFG_HAS_BEGUN                   = 18196,
    ...
    LANG_BG_BFG_A_NEAR_VICTORY              = 10598,
    LANG_BG_BFG_H_NEAR_VICTORY              = 10599,
};
