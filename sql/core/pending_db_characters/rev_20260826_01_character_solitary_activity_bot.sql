-- Ownership registry for disposable bots created exclusively for an Одиночка activity.
-- Ordinary Playerbots never enter this table and therefore can never be reaped by this subsystem.
